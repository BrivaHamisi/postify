...
@endif
        ...
        <div class="w-full max-w-md bg-white dark:bg-[#161615] rounded-lg shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] p-6 lg:p-8 mb-6 transition-all duration-300 transform starting:translate-y-4 starting:opacity-0 translate-y-0 opacity-100">
            ...
            <h1 class="text-2xl font-medium text-[#1b1b18] dark:text-[#EDEDEC] mb-2">Logged In</h1>
            <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm text-center">Congratulations! Authentication Successful</p>
            </div>
        ...
        <div class="w-full max-w-md bg-white dark:bg-[#161615] rounded-lg shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] p-6 lg:p-8 mb-6 transition-all duration-300 transform starting:translate-y-4 starting:opacity-0 translate-y-0 opacity-100">
            ...
            <div class="mt-6 text-center">
                ...
                <a href="#" class="text-sm text-[#f53003] dark:text-[#FF4433] hover:underline ml-1">Log in</a>
            </div>
        ...
        <div class="w-full max-w-md bg-white dark:bg-[#161615] rounded-lg shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] p-6 lg:p-8 mb-6 transition-all duration-300 transform starting:translate-y-4 starting:opacity-0 translate-y-0 opacity-100">
            <div class="flex flex-col items-center mb-6">
                ...
                <h1 class="text-2xl font-medium text-[#1b1b18] dark:text-[#EDEDEC] mb-2">Login to your account</h1>
                <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm text-center">Join our community and start your journey with us.</p>
            </div>
            ...
            <div class="mt-6 text-center">
                <span class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Dont have an account?</span>
                <a href="#" class="text-sm text-[#f53003] dark:text-[#FF4433] hover:underline ml-1">Sign Up</a>
            </div>
